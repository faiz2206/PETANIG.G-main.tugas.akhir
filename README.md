...
![alt text](https://github.com/faiz2206/PETANIG.G-main.tugas.akhir/blob/main/tugas2/1.jpeg?raw=true)
# Setelah login kita akan di peri peringatan dari google ingin menyimpan username dan password atau tidak
![alt text](https://github.com/faiz2206/PETANIG.G-main.tugas.akhir/blob/main/tugas2/2.jpeg?raw=true)
# Setelah peringatan dari google lanjut kita akan diarahkan pada halaman selamat datang
![alt text](https://github.com/faiz2206/PETANIG.G-main.tugas.akhir/blob/main/tugas2/3.jpeg?raw=true)
# Setelah itu lanjut next pada halaman selanjutnya yaitu navigation map
![alt text](https://github.com/faiz2206/PETANIG.G-main.tugas.akhir/blob/main/tugas2/4.jpeg?raw=true)
# Jika akses lokasi tidak di idzinkan maka akan ada notifikasi setelah di idzinkan akan lanjut pada halaman not found karena belum ada data yang masuk
![alt text](https://github.com/faiz2206/PETANIG.G-main.tugas.akhir/blob/main/tugas2/5.jpeg?raw=true)
# Halaman tambah data petani
![alt text](https://github.com/faiz2206/PETANIG.G-main.tugas.akhir/blob/main/tugas2/6.jpeg?raw=true)
# Halaman insert data setelah data terisi dan kita insert maka kolom data sudah otomatis terisi 
